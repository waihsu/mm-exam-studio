...
import { PaperPdfPreviewScreen } from "@/features/papers/components/paper-pdf-preview-screen";

export default function QuestionPaperPreviewRoute() {
  ...
  return <PaperPdfPreviewScreen paperId={paperId} />;
}
