...
const styles = StyleSheet.create({
  ...
  itemQuestionLabel: { color: "#202321", fontSize: 14, fontWeight: "800" },
  itemMetaCluster: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  itemMetaBadgeLabel: { color: "#6E706B", fontSize: 11, fontWeight: "700" },
  itemBody: { color: "#202321", fontSize: 17, lineHeight: 28 },
  optionsWrap: { gap: 10 },
  optionChip: {
  ...
  optionChipSelected: { backgroundColor: "#F5E4DA", borderColor: "#D76F55" },
  optionChipCorrect: { backgroundColor: "#E7EFE9", borderColor: "#48766B" },
  optionChipLabel: { color: "#202321", fontSize: 14, lineHeight: 21 },
  answerInput: {
    backgroundColor: "#F8F5EE",
    borderColor: "#CFC9BD",
    borderRadius: 10,
  ...
  matchingTitle: { color: "#202321", fontSize: 13, fontWeight: "700" },
  matchingHint: { color: "#6E706B", fontSize: 12 },
  ...
  matchingPromptCardPaired: { borderColor: "#A8C9BD" },
  matchingPromptHeader: {
    alignItems: "center",
    flexDirection: "row",
    justifyContent: "space-between",
  },
  matchingPromptIndex: { color: "#48766B", fontSize: 12, fontWeight: "800" },
  matchingPromptStatus: { color: "#48766B", fontSize: 11, fontWeight: "700" },
  matchingPromptPending: { color: "#AD5948", fontSize: 11, fontWeight: "700" },
  matchingLeft: { color: "#202321", fontSize: 13, fontWeight: "700" },
  matchingAssignedBox: {
    backgroundColor: "#F8F5EE",
    borderRadius: 10,
    gap: 4,
  ...
  matchingAssignedValue: { color: "#202321", fontSize: 12, fontWeight: "600" },
  matchingAssignedPlaceholder: { color: "#96938A", fontWeight: "500" },
  matchingAnswerBank: {
  ...
  matchingBankTitle: { color: "#4F514B", fontSize: 12, fontWeight: "700" },
  matchingSelectedPrompt: { color: "#48766B", fontSize: 12, fontWeight: "600" },
  matchingBankHint: { color: "#6E706B", fontSize: 11 },
  matchingChoices: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  matchingChoiceLabel: { color: "#4F514B", fontSize: 12, fontWeight: "600" },
  matchingChoiceLabelActive: { color: "#48766B" },
  matchingChoiceLabelReassign: { color: "#AD5948" },
  matchingClearChip: {
    borderColor: "#CFC9BD",
    borderRadius: 999,
    borderWidth: 1,
  ...
  matchingClearLabel: { color: "#6E706B", fontSize: 12, fontWeight: "600" },
  resultBlock: {
    backgroundColor: "#F8F5EE",
    borderColor: "#D8D4C9",
    borderRadius: 10,
  ...
  resultCorrect: { color: "#48766B" },
  resultWrong: { color: "#AD5948" },
  resultText: { color: "#4F514B", fontSize: 12, lineHeight: 18 },
  resultRow: { gap: 2 },
  resultLabel: { color: "#4F514B", fontSize: 12, fontWeight: "700" },
  explanationText: {
    color: "#202321",
    fontSize: 12,
    lineHeight: 18,
