...
const styles = StyleSheet.create({
  ...
  submitConfirmStatLabel: { color: "#64748B", fontSize: 12, fontWeight: "700" },
  submitConfirmStatValue: { color: "#0F172A", fontSize: 18, fontWeight: "800" },
  submitConfirmBody: { color: "#0F172A", fontSize: 14, lineHeight: 21 },
  submitConfirmHint: { color: "#64748B", fontSize: 13, lineHeight: 19 },
  primaryButton: {
    alignItems: "center",
