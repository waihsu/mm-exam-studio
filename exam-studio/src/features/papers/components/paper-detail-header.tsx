...
const styles = StyleSheet.create({
  ...
  secondaryButtonLabel: { color: "#1E3A8A", fontSize: 13, fontWeight: "700" },
  backButton: { minHeight: 38, paddingHorizontal: 12 },
  buttonDisabled: { opacity: 0.5 },
  buttonPressed: { opacity: 0.78 },
  actionMessage: { color: "#047857", fontSize: 12, fontWeight: "600" },
  saveBeforeFinalizeHint: { color: "#B45309", fontSize: 12, lineHeight: 18 },
});
