...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/95 text-card-foreground flex flex-col gap-5 rounded-2xl border border-white/70 py-5 shadow-[0_20px_40px_-30px_rgba(15,23,42,0.55)] backdrop-blur-sm",
        className,
      )}
      {...props}
    />
