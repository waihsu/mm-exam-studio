...
export function GlassSignInCard({ brandLabel = "App", title = "Sign in", description = "Continue with your account.", googleLabel = "Continue with Google", submitLabel = "Sign in", defaultEmail = "", onSubmit, onGoogleSignIn, }) {
