...
export const duplicateQuestion = async (id: string, createdBy?: string) => {
  ...
  const [duplicatedQuestion] = await db
    ...
    .values({
      ...
      questionTopText: sourceQuestion.questionTopText,
      questionBottomText: sourceQuestion.questionBottomText,
      questionImageUrls: sourceQuestion.questionImageUrls ?? null,
      explanation: sourceQuestion.explanation,
      solutionTopText: sourceQuestion.solutionTopText,
      solutionBottomText: sourceQuestion.solutionBottomText,
      solutionImageUrls: sourceQuestion.solutionImageUrls ?? null,
